...
function UpdatePresets(self) {
    ...
    presets['status_connected'] = {
        ...
        style: {
            ...
            bgcolor: (0, base_1.combineRgb)(40, 40, 40),
            show_topbar: true,
        },
        steps: [],
        feedbacks: [
    ...
    presets['refresh_profile'] = {
        ...
        style: {
            ...
            size: '18',
            color: (0, base_1.combineRgb)(255, 255, 255),
            bgcolor: (0, base_1.combineRgb)(60, 60, 60),
            show_topbar: false,
        },
        steps: [
            {
    ...
    presets['add_cue_player'] = {
        ...
        style: {
            ...
            bgcolor: (0, base_1.combineRgb)(180, 180, 180),
            show_topbar: false,
        },
        steps: [
            {
    ...
    presets['lookup_cue'] = {
        ...
        style: {
            ...
            size: '18',
            color: (0, base_1.combineRgb)(255, 255, 255),
            bgcolor: (0, base_1.combineRgb)(0, 110, 200),
            show_topbar: false,
        },
        steps: [
            {
    ...
    presets['delete_cue'] = {
        ...
        style: {
            ...
            size: '18',
            color: (0, base_1.combineRgb)(255, 255, 255),
            bgcolor: (0, base_1.combineRgb)(140, 0, 0),
            show_topbar: false,
        },
        steps: [
            {
